...
export const ReviewForm = () => {
  ...
  const handleRatingChange = ({target}:ChangeEvent<HTMLInputElement>) => {
    setInitialValues({...initialValues, rating: target.value });
  };
  const handleReviewInputChange = ({target}:ChangeEvent<HTMLTextAreaElement>) => {
    setInitialValues({...initialValues, review: target.value });
  };
  ...
  return (
    <form className="reviews__form form">
      ...
      <textarea onChange={handleReviewInputChange} className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved"></textarea>
