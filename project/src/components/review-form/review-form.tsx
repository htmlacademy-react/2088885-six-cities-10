...
export const ReviewForm = () => {
  ...
  return (
    <form className="reviews__form form">
      ...
      <textarea onChange={onReviewInputChange} value={review} className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved"></textarea>
